...
final List<Idiom> regretIdioms = [
  ...
  Idiom(
    ...
    exampleTranslationAr: "توقف عن التردد واغتنم الفرصة بالتقدم للوظيفة الآن.",
  ),
  // 32.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "خسر كل مدخراته بالمقامرة؛ لقد تعلم بالخبرة القاسية.",
  ),
  // 34.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "ندم على كلمة واحدة نطق بها تسببت في الخلاف بأكمله.",
  ),
  // 40.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "تضررت صداقتهما بسبب الخيانة لدرجة لا يمكن إصلاحها.",
  ),
  // 42.
  Idiom(
    ...
    exampleTranslationAr: "بدلاً من الخوض في الفشل، يجب أن تحمد الله على نعمك.",
  ),
  // 43.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "تفوهت بكلام ندمت عليه عندما سألتها عن زوجها السابق.",
  ),
  // 47.
  Idiom(
