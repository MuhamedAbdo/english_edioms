...
final List<Idiom> timeIdioms = [
  ...
  Idiom(
    ...
    explanationAr: "العمل بسرعة شديدة ومجهدة لإنهاء مهمة قبل موعد نهائي وشيك.",
    exampleEn: "The team worked against the clock to finish the presentation.",
    exampleTranslationAr: "عمل الفريق في سباق مع الزمن لإنهاء العرض التقديمي.",
  ),
  // 4.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "شركتنا دائماً أكثر تطوراً من غيرها في التكنولوجيا.",
  ),
  // 9.
  Idiom(
  ...
  Idiom(
    ...
    exampleEn: "After his recovery, he studied hard to make up for lost time.",
  ...
  Idiom(
    ...
    exampleTranslationAr: "الشركة تُضيع الوقت دون تقدم حتى وصول المدير الجديد.",
  ),
  // 19.
  Idiom(
    phrase: "To do time",
  ...
  Idiom(
    ...
    exampleEn: "The construction project is already two weeks behind schedule.",
    exampleTranslationAr:
  ...
  Idiom(
    ...
    explanationAr: "القيام بشيء لإبطاء العملية أو التأجيل لكسب مزيد من الوقت.",
  ...
  Idiom(
    ...
    exampleTranslationAr: "العمال مقيدون بالوقت لإنهاء الإصلاح قبل حلول الليل.",
  ),
  // 48.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "بفضل مهاراته، إنها مسألة وقت فقط قبل أن تتم ترقيته.",
  ),
  // 50.
  Idiom(
  ...
  Idiom(
    ...
    exampleEn: "Businesses must keep up with the times to remain competitive.",
    exampleTranslationAr:
  ...
  Idiom(
    ...
    exampleTranslationAr: "لا أستطيع الذهاب للعشاء الليلة، لكنني سأؤجل الموعد.",
  ),
  // 58.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "كافح الموظف الجديد لمواكبة الوتيرة السريعة للمكتب.",
  ),
  // 60.
  Idiom(
  ...
  Idiom(
    ...
    explanationAr: "أن يكون شيئاً قديماً أو عتيقاً أو لم يعد صالحاً للاستخدام.",
  ...
  Idiom(
    ...
    exampleTranslationAr: "نتوقع من المقاول إكمال الإصلاحات في الوقت المناسب.",
  ),
  // 80.
  Idiom(
  ...
  Idiom(
    ...
    explanationAr: "تأخير قرار أو تصرف حتى تنتهي فترة من الاضطراب أو المشاكل.",
    exampleEn:
  ...
  Idiom(
    ...
    exampleEn: "Stepping into that old bookstore is like being in a time warp.",
    exampleTranslationAr:
  ...
  Idiom(
    ...
    exampleTranslationAr: "كان المسعفون يسابقون الزمن للوصول إلى موقع الحادث.",
  ),
  // 98.
  Idiom(
  ...
  Idiom(
    ...
    exampleTranslationAr: "بفضل التخطيط الدقيق، نحن قبل الموعد المحدد للتجديد.",
  ),
];
