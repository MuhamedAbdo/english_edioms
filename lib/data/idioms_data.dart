...
final Map<String, List<Idiom>> idiomsData = {
  'عبارات عامة': [
    Idiom(
      ...
      explanationAr:
          "تجنب قول الشيء بشكل مباشر، وغالباً ما يكون ذلك لتجنب الإحراج أو الصراع.",
      exampleEn:
          "Stop beating around the bush and tell me what you really want.",
      exampleTranslationAr:
          "توقف عن الدوران حول الموضوع وأخبرني ماذا تريد حقاً.",
    ),
    Idiom(
      phrase: "A piece of cake",
      meaningAr: "سهل جداً / أمر هين",
      explanationAr:
          "وصف مهمة أو نشاط بأنه سهل جداً أو بسيط ولا يتطلب جهداً كبيراً.",
    ...
    Idiom(
      ...
      explanationAr:
          "لا تحكم على قيمة أو طبيعة شخص أو شيء من مظهره الخارجي فقط.",
      exampleEn:
    ...
    Idiom(
      ...
      exampleTranslationAr:
          "الساعة السابعة مساءً. لننهِ العمل ونذهب إلى المنزل.",
    ),
    Idiom(
    ...
    Idiom(
      ...
      exampleTranslationAr:
          "رده الغاضب لم يزد الأمر إلا سوءاً (زاد الطين بلة).",
    ),
    Idiom(
    ...
    Idiom(
      ...
      explanationAr:
          "يعني أن الوقت قد حان لاتخاذ قرار أو اتخاذ الخطوة التالية.",
    ...
    Idiom(
      ...
      exampleEn:
          "I can't come to the party tonight, but I'll take a rain check.",
      exampleTranslationAr:
    ...
    Idiom(
      ...
      exampleTranslationAr: "نوِّع استثماراتك؛ لا تضع كل البيض في سلة واحدة.",
    ),
    Idiom(
    ...
    Idiom(
      ...
      explanationAr: "مدح شخص أو إطراءه بشكل مفرط لجعلهم يفعلون شيئاً لك.",
      exampleEn:
          "She always tries to butter up the boss before asking for a raise.",
      exampleTranslationAr:
          "تحاول دائماً التودد للمدير قبل طلب زيادة في الراتب.",
    ),
    Idiom(
    ...
    Idiom(
      ...
      explanationAr:
          "شخص كسول يقضي وقتاً طويلاً في مشاهدة التلفزيون أو الجلوس على الأريكة.",
      exampleEn:
    ...
    Idiom(
      ...
      explanationAr:
          "مقارنة شيئين مختلفين تماماً لدرجة أن المقارنة لا تكون مجدية أو منطقية.",
      exampleEn:
    ...
    Idiom(
      ...
      exampleTranslationAr:
          "كنا نتحدث للتو عن جون، وعلى ذكر الشيطان، ها هو ذا!",
    ),
    Idiom(
    ...
    Idiom(
      ...
      exampleEn:
          "Do you get the picture now, or do I need to explain it again?",
      exampleTranslationAr:
    ...
    Idiom(
      ...
      explanationAr: "الانضمام إلى نشاط أو اتجاه معين أصبح شائعاً مؤخراً.",
      exampleEn:
    ...
    Idiom(
      ...
      exampleEn:
          "It was hard at first, but I'm finally getting the hang of it.",
      exampleTranslationAr:
          "كان الأمر صعباً في البداية، لكنني أخيراً أصبحت أتقنه.",
    ),
    Idiom(
    ...
    Idiom(
      ...
      explanationAr:
          "تحسين السلوك أو طريقة العمل ليكون أكثر مسؤولية أو أخلاقية.",
    ...
    Idiom(
      ...
      explanationAr: "وصف حدث يحدث بشكل غير متكرر أو نادراً جداً.",
    ...
    Idiom(
      ...
      exampleTranslationAr:
          "أعلن عن خبري السعيد قبل أن أفعل، سارقاً كل الأضواء.",
    ),
    Idiom(
    ...
    Idiom(
      ...
      exampleTranslationAr:
          "لم أكن أريد الذهاب، لكن صديقي أصر عليّ (لوى ذراعي).",
    ),
    Idiom(
    ...
    Idiom(
      ...
      exampleTranslationAr:
          "إنه يحمل حقداً (يستاء) بسبب عدم حصوله على الترقية.",
    ),
    Idiom(
    ...
    Idiom(
      ...
      exampleEn:
          "After the new manager arrived, I had to take a back seat in the decision-making.",
      exampleTranslationAr:
